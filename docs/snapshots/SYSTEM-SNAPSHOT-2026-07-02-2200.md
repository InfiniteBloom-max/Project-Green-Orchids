...
3. **Image asset wiring** (catalogue/landing/product-detail) — explicitly **not** touched this session per your instruction; `docs/image-assets/generated-image-assets/` still holds 40+ unused images, `apps/web/public/images/` still doesn't exist.
